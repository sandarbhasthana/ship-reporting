...
export const InspectionReportScalarFieldEnum = {
  ...
  formNo: 'formNo',
  applicableFomSections: 'applicableFomSections',
...
export const InspectionEntryScalarFieldEnum = {
  id: 'id',
  reportId: 'reportId',
  srNo: 'srNo',
  deficiency: 'deficiency',
  mastersCauseAnalysis: 'mastersCauseAnalysis',
  correctiveAction: 'correctiveAction',
  preventiveAction: 'preventiveAction',
  completionDate: 'completionDate',
  companyAnalysis: 'companyAnalysis',
  status: 'status',
  officeSignUserId: 'officeSignUserId',
  officeSignDate: 'officeSignDate',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt'
} as const
